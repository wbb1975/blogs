...
![types-of-mounts-bind](https://github.com/wbb1975/blogs/blob/master/container/images/types-of-mounts-bind.png)

## 选择-v或--mount标记
最初，-v或--volume标记用于独立容器而--mount用于一大群服务。但是，从Docker 17.06开始，--mount选项也可用于独立的容器。基本上，--mount更直白，更冗长。最大的区别在于-v在一个字段中把多个选项绑定在一起，而--mount把选项分开。下面是每个选项的语法对比。
